...
//                        $moria_79 = 2.0;
    ...
    if ($typems == 0)
    {
        ...
        {
            $desc = array();
            $rejr = "Απαιτείται ελάχιστη προϋπηρεσία στη γενική εκπαίδευση, τουλάχιστον 3 έτη.";
            return -1;
        }
        if ($years_mousika < 2)
        {
            $desc = array();
            $rejr = "Απαιτείται ελάχιστη προϋπηρεσία στα μουσικά σχολεία, τουλάχιστον 2 έτη.";
            return -1;
        }
    }
    if ($typems == 1)
